...
rem This script performs a test of the program tab2vcf.py
...
rem Run the program tab2vcf.py

%PYTHON% %PYTHON_OPTIONS% tab2vcf.py ^
    --tab=%DATA_DIR%\variants-TabularFormatExample.txt ^
