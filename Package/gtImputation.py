...
class MainWindow(QMainWindow):
    ...
    def build_gui(self):
        ...
        action_recreate_gtimputation_config_file = QAction(f'Recreate {genlib.get_app_short_name()} config file', self)
        action_recreate_gtimputation_config_file.setStatusTip(f'Recreate the {genlib.get_app_short_name()} config file.')
        action_recreate_gtimputation_config_file.triggered.connect(self.action_recreate_gtimputation_config_file_clicked)

        action_browse_gtimputation_config_file = QAction(f'Browse {genlib.get_app_short_name()} config file', self)
        action_browse_gtimputation_config_file.setStatusTip(f'Browse the {genlib.get_app_short_name()} config file.')
        action_browse_gtimputation_config_file.triggered.connect(self.action_browse_gtimputation_config_file_clicked)
        ...
        menu_configuration.addAction(action_recreate_gtimputation_config_file)
        menu_configuration.addAction(action_browse_gtimputation_config_file)
    ...
    def action_recreate_gtimputation_config_file_clicked(self):
        '''
        ...
        subwindow = configuration.RecreateGtImputationConfigFile(self)
    ...
    def action_browse_gtimputation_config_file_clicked(self):
        '''
        ...
        subwindow = configuration.BrowseGtImputationConfigFile(self)
    ...
    def action_install_miniconda3_clicked(self):
        ...
        subwindow = bioinfosw.InstallBioinfoSoftware(self, genlib.get_miniconda3_code())
    ...
    def action_run_naive_process_clicked(self):
        ...
        subwindow = imputations.NaiveImputation(self)
    ...
    def action_review_naive_imputation_clicked(self):
        ...
        subwindow = imputations.NaiveImputationReview(self)
    ...
    def action_run_gtdb_process_clicked(self):
        ...
        subwindow = imputations.GenotypeDatabase(self)
    ...
    def action_run_som_process_clicked(self):
        ...
        subwindow = imputations.SOMImputation(self)
    ...
    def action_review_som_imputation_clicked(self):
        ...
        subwindow = imputations.SOMImputationReview(self)
    ...
    def action_browse_submitting_logs_clicked(self):
        ...
        subwindow = logs.BrowseSubmittingLogs(self)
    ...
    def action_browse_result_logs_clicked(self):
        ...
        subwindow = logs.BrowseResultLogs(self)
    ...
    def accion_about_clicked(self):
        ...
        dialog_about = dialogs.About(self)
        dialog_about.exec()
